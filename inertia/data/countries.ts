export const COUNTRIES = [
  ...
  { code: 'SS', name: 'República de Sudán del Sur' },
  ...
  { code: 'TD', name: 'Chad' },
  { code: 'TF', name: 'Territorios Australes y Antárticas Franceses' },
  { code: 'TG', name: 'Togo' },
